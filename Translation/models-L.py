...
class MyGRUCell(nn.Module):
    ...
    def forward(self, x, h_prev):
        ...
        ## navie approach
        # z = F.sigmoid(self.W_z(x) + self.W_hz(h_prev) + self.b_z.weight)
        # r = F.sigmoid(self.W_r(x) + self.W_hr(h_prev) + self.b_r.weight)
        # g = F.tanh(self.W_g(x) + r * (self.W_hg(h_prev) + self.b_g.weight))
...
class Attention(nn.Module):
    ...
    def forward(self, hidden, annotations):
        ...
        # expanded_hidden = batch_size x seq_len x hidden_size
...
class AttentionDecoder(nn.Module):
    ...
    def forward(self, x, h_prev, annotations):
        ...
        # FILL THIS IN
        # ------------
        # attention_weights = batch_size x seq_len x 1
        #
        # context = ...
        # embed_and_context = ...
        # h_new = ...
        ...
        # context = batch_size x hidden_size x 1
        ...
        # context = batch_size x 2*hidden_size
